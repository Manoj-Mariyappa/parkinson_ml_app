...
try:
    parkinson_model = pickle.load(open('C:/Users/Manoj/Desktop/Parkinson disease prediction system/model/rftrained_model.sav', 'rb'))
    scaler = pickle.load(open('C:/Users/Manoj/Desktop/Parkinson disease prediction system/model/scaler.sav', 'rb'))
except:
